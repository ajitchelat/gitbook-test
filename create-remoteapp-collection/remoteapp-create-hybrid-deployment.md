...
2. Set up your virtual network. Check out the [VNET planning](remoteapp-planvnet.md) and [sizing]() information.
...
Make sure you review the [VNET planning](remoteapp-planvnet.md) and [VNET size]() information before you create your VNET.
