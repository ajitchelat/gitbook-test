...
There are 2 AD Connect scenarios - using password synchronization or using AD federation. Check out the [AD Connect information]() to figure out which of these works best for you.
