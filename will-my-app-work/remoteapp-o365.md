...
**Hey, did you know we have a new, better article that will soon replace this? Check out [How to use your Office 365 subscription with Azure RemoteApp](). It covers all the info you need for using Office 365 + Azure RemoteApp.**
...
To use Office 365 Shared Computer Activation, you need to create a [custom template]() and install Office 365 ProPlus there, following [these directions](https://technet.microsoft.com/library/dn782858.aspx).
